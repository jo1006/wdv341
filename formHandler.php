...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inStatus = $_POST["status"];		//Get the value entered in the full time checkbox
	$inDegree = $_POST["degree"];			//Get the value entered in the degree radio button
	$inMajor = $_POST["major"];				//Get the value entered in the major drop down list
